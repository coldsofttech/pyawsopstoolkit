...
from pyawsopstoolkit.advsearch import OR, BETWEEN
...
class TestUser(unittest.TestCase):
    ...
    @patch('pyawsopstoolkit.advsearch.iam.__handlers__._list_users', return_value=[{
        'Path': '/',
        'UserName': 'test_user',
    ...
    @patch('pyawsopstoolkit.advsearch.iam.__handlers__._get_user', return_value={
        'Path': '/',
        'UserName': 'test_user',
        'UserId': 'AID2MAB8DPLSRHEXAMPLE',
        'Arn': 'arn:aws:iam::123456789012:user/test_user',
    ...
    @patch('pyawsopstoolkit.advsearch.iam.__handlers__._get_login_profile', return_value={
        'UserName': 'test_user',
    ...
    def test_search_users_with_login_profile(
        ...
        from pyawsopstoolkit.models.iam.user import User, LoginProfile
        from pyawsopstoolkit.models.iam import PermissionsBoundary
    ...
    @patch('pyawsopstoolkit.advsearch.iam.__handlers__._list_access_keys', return_value=[{
        'UserName': 'test_user',
        'AccessKeyId': 'ACCESSKEY_ID1',
        'Status': 'Active',
        'CreateDate': datetime(2022, 5, 18)
    }])
    @patch('pyawsopstoolkit.advsearch.iam.__handlers__._get_access_key_last_used', return_value={
        'UserName': 'test_user',
        'AccessKeyLastUsed': {
