...
class TestSecurityGroup(unittest.TestCase):
    ...
    @patch('pyawsopstoolkit.advsearch.ec2.__handlers__._list_security_groups', return_value=[{
    ...
    def test_search_security_groups_basic(
        ...
        from pyawsopstoolkit.models.ec2.security_group import SecurityGroup
